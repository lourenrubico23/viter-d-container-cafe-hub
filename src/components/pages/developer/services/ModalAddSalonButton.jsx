...
const ModalAddSalonButton = ({ itemEdit, setIsSalonButton, servicesData }) => {
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              const data = {
                ...values,
                services_salon_services_images: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
                  ...
                  <div className="form-input">
                    ...
                    <div className="input-wrapper">
                      <InputTextArea
                        ...
                        type="text"
                        name="services_salon_facebook_link"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
...
export default ModalAddSalonButton;
