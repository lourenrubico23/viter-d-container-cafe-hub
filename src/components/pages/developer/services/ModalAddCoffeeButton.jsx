...
const ModalAddCoffeeButton = ({
  ...
  const initVal = {
    ...
    services_coffee_button_a:
      servicesData?.data[0]?.services_coffee_button_a ?? "",
    services_coffee_button_b:
      servicesData?.data[0]?.services_coffee_button_b ?? "",
    services_coffee_facebook_link:
      servicesData?.data[0]?.services_coffee_facebook_link ?? "",
    services_coffee_menu_images:
      servicesData?.data?.[0]?.services_coffee_menu_images ?? "",

    services_coffee_menu_images_old:
      servicesData?.data?.[0]?.services_coffee_menu_images ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                services_coffee_menu_images: Array.from(photoArrayList).map(
                  (item) =>
                    JSON.stringify({
                      name: item.name,
                      id: item?.id || "",
              ...
              return (
                <Form className="modal-form">
                  <div className="form-input">
                    ...
                    <div className="mt-5">
                      <div
                        className={`relative mt-7 mb-4 border border-gray-300 rounded-md hover:border-primary hover:border-dashed ${
                    ...
                    <div className="input-wrapper">
                      <InputTextArea
                        ...
                        type="text"
                        name="services_coffee_facebook_link"
                        disabled={mutation.isPending}
                      />
                    </div>
                    <div className="input-wrapper">
...
export default ModalAddCoffeeButton;
