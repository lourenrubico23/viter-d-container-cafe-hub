...
const ModalAddCoffeeMenu = ({ itemEdit, setIsCoffeeMenu, servicesData }) => {
  ...
  return (
    ...
    >
      <div className="modal-title">
        <h2 className="text-sm">Edit Coffee Menu</h2>
            ...
            const data = {
              ...
              services_coffee_menu_images:
                photoArrayList.length > 0
                  ...
                  : servicesData?.data?.services_coffee_menu_images || "",
            };
            ...
            return (
              <Form className="modal-form">
                <div className="form-input">
                  <div className="mt-5">
                    <span className="top-20 px-2 text-[12px]">Coffee Menu</span>
                    ...
                    <button
                      ...
                      disabled={
                        ((mutation.isPending || !props.dirty) &&
                          photoArrayList === null) ||
                        photoArrayList === "" ||
                        initVal.services_coffee_menu_images ===
                          photoArrayList?.name
                      }
                    >
...
export default ModalAddCoffeeMenu;
