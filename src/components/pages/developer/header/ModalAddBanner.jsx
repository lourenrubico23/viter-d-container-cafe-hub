...
const ModalAddBanner = ({ itemEdit, headerData, setIsBanner, setItemEdit }) => {
  ...
  const initVal = {
    ...
    header_banner_img_old: headerData?.data?.[0]?.header_banner_img ?? "",
    pendingDeleteFile: [],
  };
        ...
        <div className="modal-content">
          <Formik
            ...
            onSubmit={async (values) => {
              ...
              const data = {
                ...values,
                header_banner_img: Array.from(photoArrayList).map((item) =>
                  JSON.stringify({
                    name: item.name,
                    id: item?.id || "",
                  })
