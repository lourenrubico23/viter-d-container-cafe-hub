      ...
      <div className="modal-content">
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            const data = {
              ...values,
              testimonial_client_img_b: photo
                ? photo.name
                : testimonialData?.data?.[0]?.testimonial_client_img_b,
            };
                ...
                <div className="form-input">
                          ...
                          src={
                            photo
                              ...
                              : testimonialData?.data?.[0]
                                  ?.testimonial_client_img_b // Get image from testimonialData if no new photo
                              ? `${devBaseImgUrl}/${testimonialData.data[0].testimonial_client_img_b}`
                              : ""
                          }
                          alt="Logo"
                        ...
                        <button>
                          ...
                          <InputPhotoUpload
                            ...
                            onChange={(e) =>
                              handleChangePhoto(
                                e,
                                initVal.testimonial_client_img_b
                              )
                            }
                  ...
                  <div className="input-wrapper">
                    <InputText
                      label="Name"
                      type="text"
                      name="testimonial_client_name_b"
                  ...
                  <div className="input-wrapper">
                    <InputTextArea
                      label="Message"
                      type="text"
                      name="testimonial_client_message_b"
                      disabled={mutation.isPending}
                    />
                  </div>
                </div>
                    ...
                    <button
                      ...
                      disabled={
                        ((mutation.isPending || !props.dirty) &&
                          photo === null) ||
                        photo === "" ||
                        initVal.testimonial_client_img_b === photo?.name
                      }
                    >
...
export default ModalAddTestimonialB;
