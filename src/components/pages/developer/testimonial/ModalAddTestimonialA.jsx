      ...
      <div className="modal-content">
        <Formik
          ...
          onSubmit={async (values) => {
            ...
            const data = {
              ...values,
              testimonial_client_img_a: photo
                ? photo.name
                : testimonialData?.data?.[0]?.testimonial_client_img_a,
            };
                ...
                <div className="form-input">
                          ...
                          src={
                            photo
                              ...
                              : testimonialData?.data?.[0]
                                  ?.testimonial_client_img_a // Get image from testimonialData if no new photo
                              ? `${devBaseImgUrl}/${testimonialData.data[0].testimonial_client_img_a}`
                              : ""
                          }
                          alt="Logo"
                        ...
                        <button>
                          ...
                          <InputPhotoUpload
                            ...
                            onChange={(e) =>
                              handleChangePhoto(
                                e,
                                initVal.testimonial_client_img_a
                              )
                            }
                  ...
                  <div className="input-wrapper">
                    <InputText
                      label="Name"
                      type="text"
                      name="testimonial_client_name_a"
                    ...
                    <button
                      ...
                      disabled={
                        ((mutation.isPending || !props.dirty) &&
                          photo === null) ||
                        photo === "" ||
                        initVal.testimonial_client_img_a === photo?.name
                      }
                    >
...
export default ModalAddTestimonialA;
